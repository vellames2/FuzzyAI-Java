...
public final class FuzzyAI {
    ...
    public static JPanel painelAjuda() {
        //Cria o botao com link do JavaDOC
        JPanel painelAjuda = new JPanel();
        JButton btnJava = new JButton("JavaDOC");
        ...
        //Cria o botao com link do Manual do Usuário
        JButton btnManualUsuario = new JButton("Manual do Usuário");
        btnManualUsuario.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    java.awt.Desktop.getDesktop().browse(new java.net.URI("https://drive.google.com/open?id=1C2YqAfvfAXzL0HipPHmlQ7p9X9AO4pkC"));
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(null, "Não foi possível abrir o browser, por favor acesse o link abaixo para ter acesso ao conteudo:\nhttps://drive.google.com/open?id=1C2YqAfvfAXzL0HipPHmlQ7p9X9AO4pkC");
                }
            }
        });
        //Cria o botao com link do Manual do JSON
        JButton btnManualJSON = new JButton("Manual JSON");
        btnManualJSON.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    java.awt.Desktop.getDesktop().browse(new java.net.URI("https://drive.google.com/open?id=1UdgbVKsxcbN0k0xYQXEoZirL5rjQhomc"));
                } catch (Exception ex) {
                    JOptionPane.showMessageDialog(null, "Não foi possível abrir o browser, por favor acesse o link abaixo para ter acesso ao conteudo:\nhttps://drive.google.com/open?id=1UdgbVKsxcbN0k0xYQXEoZirL5rjQhomc");
                }
            }
        });
        //Insere os elementos no painel
        painelAjuda.add(btnJava);
        painelAjuda.add(btnManualUsuario);
        painelAjuda.add(btnManualJSON);
        ...
        enviar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    TelaResultado telaResultado = new TelaResultado(valoresEntrada ,modeloFuzzy, variaveisFuzzyficadas, imagem, variavel);
